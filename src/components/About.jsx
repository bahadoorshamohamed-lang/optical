...
const About = () => {
  ...
  return (
    <div id="about" className="bg-white text-slate-800 overflow-hidden font-sans select-none">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 relative">
              <div className="relative mx-auto max-w-md lg:max-w-none min-h-[440px] sm:min-h-[500px]">
                ...
                <div className="absolute bottom-4 right-0 w-[55%] rounded-3xl overflow-hidden shadow-2xl border-4 border-white aspect-[4/3] bg-slate-200 z-10 transform hover:scale-105 transition-transform duration-500">
                  <img
                ...
                <div className="absolute top-8 right-6 bg-slate-900 text-white px-5 py-3 rounded-2xl border border-slate-700 shadow-2xl z-20">
                  <div className="text-xs font-black tracking-widest uppercase text-emerald-400">VISION CARE</div>
                  <div className="text-[10px] font-bold text-slate-300 uppercase tracking-wider">Optical Excellence</div>
                </div>
            ...
            <div className="lg:col-span-6 space-y-6 lg:pl-6">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif text-optom-slate-heading tracking-tight leading-tight">
              ...
              <div className="pt-2 grid grid-cols-2 gap-6 border-t border-slate-200/80">
                <div>
                  <div className="text-2xl font-serif font-bold text-optom-slate-heading">20 / 20</div>
                  <div className="text-xs text-slate-500 font-medium">Refraction Precision</div>
                </div>
                <div>
                  <div className="text-2xl font-serif font-bold text-optom-green">100%</div>
                  <div className="text-xs text-slate-500 font-medium">UV & HEV Blue Shield</div>
                </div>
              </div>
      ...
      <section className="py-20 lg:py-28 bg-white border-b border-slate-200/60 text-center relative">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          
          <Quote className="w-12 h-12 text-emerald-300 mx-auto opacity-40 mb-6" />

          <blockquote className="text-2xl sm:text-3xl lg:text-4xl font-serif text-optom-slate-heading font-light leading-relaxed tracking-tight">
            “The right eyewear doesn't just improve how you see the world. It changes how the world sees you.”
          </blockquote>

          <div className="w-16 h-0.5 bg-optom-green mx-auto mt-8 opacity-60" />
      ...
      <section className="py-24 lg:py-36 bg-white text-slate-800 relative overflow-hidden select-none border-b border-slate-200/80">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20 pointer-events-none">
          <h2 className="text-5xl sm:text-7xl lg:text-8xl font-serif font-black text-slate-100/80 tracking-tight select-none uppercase">
            OUR FRAMES
          </h2>
        </div>

        {/* Top Header Tag */}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8 relative z-30 flex items-center justify-between">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-50 border border-emerald-200 text-optom-green text-xs font-extrabold uppercase tracking-widest shadow-2xs">
        ...
        <div className="relative overflow-hidden py-16 group z-30">
          
          {/* Side Fade Gradient Masks (White Theme) */}
          <div className="absolute top-0 bottom-0 left-0 w-24 sm:w-44 bg-gradient-to-r from-white via-white/80 to-transparent z-40 pointer-events-none" />
          <div className="absolute top-0 bottom-0 right-0 w-24 sm:w-44 bg-gradient-to-l from-white via-white/80 to-transparent z-40 pointer-events-none" />

          {/* Marquee Track (Pauses on Hover) */}
          <div className="flex items-center gap-8 sm:gap-12 w-max animate-marquee-rtl group-hover:[animation-play-state:paused] transition-all">
              ...
              return (
                <div
                  ...
                  className={`relative rounded-3xl overflow-hidden border transition-all duration-500 cursor-pointer flex-shrink-0 group/frame ${item.staggerClass || ''} ${
                    isHovered 
                      ? 'scale-115 z-50 border-optom-green shadow-2xl ring-2 ring-emerald-300/80 bg-white' 
                      : 'border-slate-200/90 bg-white shadow-md hover:shadow-xl opacity-90 hover:opacity-100'
                  }`}
                  style={{
                    width: idx % 2 === 0 ? '240px' : '280px',
                    height: idx % 2 === 0 ? '300px' : '350px',
                  }}
                >
                  {/* Frame Image */}
                  <img
                  ...
                  <div className="absolute bottom-4 left-4 right-4 text-white z-10 space-y-1 transition-all duration-300 transform translate-y-3 opacity-0 group-hover/frame:opacity-100 group-hover/frame:translate-y-0 pointer-events-none">
                    <div className="text-[10px] font-black text-emerald-400 tracking-widest uppercase">
                      {item.category}
                    </div>
                    <div className="text-sm font-serif font-extrabold tracking-tight text-white group-hover/frame:text-emerald-300 transition-colors">
                      {item.name}
                    </div>
                  </div>
      ...
      <section className="py-24 lg:py-32 bg-white text-slate-800 relative overflow-hidden select-none border-b border-slate-200/80">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-16">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-4">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif font-light text-optom-slate-heading tracking-tight leading-tight">
              ...
              {activeCorePurpose.map((item, idx) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left p-6 rounded-3xl transition-all duration-500 border flex items-center justify-between cursor-pointer ${
                      isActive 
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div className={`p-3 rounded-2xl transition-colors ${isActive ? 'bg-optom-green text-white shadow-xs' : 'bg-slate-100 text-slate-600'}`}>
                        <Target className="w-6 h-6" />
                      </div>
                      <div>
                        <div className="text-lg font-serif font-extrabold text-optom-slate-heading">{item.label}</div>
                        <div className="text-xs text-slate-500 font-medium">{item.tagline}</div>
                      </div>
                    </div>

                    <ArrowRight className={`w-5 h-5 transition-transform duration-300 ${isActive ? 'text-optom-green translate-x-1' : 'opacity-0'}`} />
                  </button>
                );
              })}
            </div>
