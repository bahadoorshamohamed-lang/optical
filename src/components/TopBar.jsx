...
const TopBar = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 text-slate-200 border-b border-white/10 text-xs py-2 px-4 sm:px-6 lg:px-8 relative z-50">
      <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-4 text-[11px] font-medium ml-auto sm:ml-0">
